      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div v-if="!show" class="modal-content">
          ...
          <div class="modal-footer border-0">
            <button type="button" @click="search" class="btn btn-primary">近くの店舗を探す</button>
        ...
        <div v-if="show" class="modal-content">
          <div class="modal-body border-0">
            ...
            <div v-for="shop in shops" :key="index" class="mb-3">
...
export default {
  ...
  methods: {
    ...
    async search() {
      try {
        console.log(this.latitude, this.longitude, this.recommend.name)
